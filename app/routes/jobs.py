...
def get_job(job_id: str, db: Annotated[Session, Depends(get_db)]) -> JobResponse:
    ...
    return JobResponse(
        ...
        transcription_device=job.transcription_device,
        language_probability=job.language_probability,
        audio_duration=job.audio_duration,
        transcription_segment_count=job.transcription_segment_count,
        transcription_warning=job.transcription_warning,
